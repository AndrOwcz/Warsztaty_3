...
<%@ include file="/WEB-INF/views/header.jsp"%>
        ...
        <div class="m-4 p-3 width-medium text-color-darker">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <form action="/deleteSolution" method="POST">
                    <input type="hidden"  name="solutionId" value="${solution.id}">
                    <div class="mt-4 ml-4 mr-4">
                        <div class="row border-bottom border-3">
                            <div class="col"><h3 class="color-header text-uppercase">Are you sure to delete:
                                <p></p>
                            ${solution.id} - ${solution.description} ?</h3></div>
