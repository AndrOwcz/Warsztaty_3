        ...
        <form action="/editExercise" method="POST">
            ...
            <div class="schedules-content">
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input value="${exercise.title}" name="title" class="form-control" rows="3" id="titleId"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input value="${exercise.description}" name="description" class="form-control" rows="3" id="descriptionId"
